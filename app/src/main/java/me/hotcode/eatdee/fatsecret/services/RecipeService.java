...
import me.hotcode.eatdee.fatsecret.utils.RecipeUtility;
...
public class RecipeService {
	 ...
	 */
	public me.hotcode.eatdee.fatsecret.services.Response<CompactRecipe> searchRecipes(String query) {
	 ...
	 */
	public me.hotcode.eatdee.fatsecret.services.Response<CompactRecipe> searchRecipes(String query, Integer pageNumber) {
		JSONObject json = request.getRecipes(query, pageNumber);
		me.hotcode.eatdee.fatsecret.services.Response<CompactRecipe> response = new Response<CompactRecipe>();
