...
public class RequestBuilder {
	...
	public String sign(String method, String uri, String[] params) throws UnsupportedEncodingException {
		...
		try {
			...
			m.init(sk);
			sign = encode(new String(me.hotcode.eatdee.fatsecret.services.Base64.encode(m.doFinal(text.getBytes()), me.hotcode.eatdee.fatsecret.services.Base64.DEFAULT)).trim());
